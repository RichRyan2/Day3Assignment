            ...
            <Container>
                <Form onSubmit={this.handleSubmit}>
                    ...
                    <Form.Group>
                        ...
                        <Form.Text>{this.state.error.nameError}</Form.Text>
                    </Form.Group>
                    <Form.Group>
                        ...
                        <Form.Text>{this.state.error.dateOfBirthError}</Form.Text>
                    </Form.Group>
                    <Form.Group>
                        ...
                        <Form.Text>{this.state.error.emailError}</Form.Text>
                    </Form.Group>
                    <Form.Group>
                        ...
                        <Form.Text>{this.state.error.contactNumberError}</Form.Text>
                    </Form.Group>
                    <Form.Group>
                        ...
                        <Form.Text>{this.state.error.aboutSelfError}</Form.Text>
                    </Form.Group>
